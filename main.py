        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="mains.py">Lifestyle Store</a>
                </div>
                ...
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-4 col-md-6 col-md-offset-3">
                        ...
                        <form  action="regisdb.py" method="get">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Branch" name="contact" required>
                            </div>
                            <div class="form-group">
                                <input  type="text" class="form-control"  placeholder="City" name="city" required>
                            </div>
                            <div class="form-group">
                                <input  type="text" class="form-control"  placeholder="Achievement" name="address" required>
                            </div>
